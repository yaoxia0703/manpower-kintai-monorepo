...
public class SystemApprovalNotificationAdapter implements ApprovalNotificationPort {
    ...
    public void requestSubmitted(
            Long companyId, Long recipientId, String requestType, Long requestId) {
    ...
    private void create(
            ...
            String title, String content, String requestType, Long requestId) {
        notificationService.create(new SysNotificationCreateCommand(
                companyId, recipientId, type, title, content, requestType, requestId));
    }
}
